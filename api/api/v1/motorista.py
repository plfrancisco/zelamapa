...
@router.put("/status")
async def update_status(payload: StatusUpdate, current_user: UsuarioModel = Depends(get_current_user)):
    """
...
@router.get("/perfil")
def get_perfil(current_user: UsuarioModel = Depends(get_current_user)):
    """
